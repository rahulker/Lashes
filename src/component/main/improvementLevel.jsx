  ...
  return (
    <>
      <section className="product-background ">
        <div className=" bg-white level-product relative text-center  marging rounded-lg">
          <div>
            <CustomTitle
            ...
            <p className="level-para">
              Unser Vorteilsprogramm ordnet dich je nach Einkaufswert pro Jahr
              in ein Level von 1 - 5 ein: Je höher dein Level, desto mehr
              Vorteile erhältst du.
            ...
            <div className="leves-cards ">
              <div className="hidden xl:grid gap-5 items-center grid-cols-5">
                <LevelCards
                  levelNum="Level 1"
          ...
          {/* floating  section */}
          <div className="absolute floating-banner rounded-md xl:flex-row lg:text-left text-center flex flex-col">
            <img
              src={PathImage.bannerImage}
              alt="woman eye"
              className="rounded-t-md lg:rounded-l-md lg:rounded-tr-none object-cover"
            />
            <div className="flex lg:items-center flex-col lg:flex-row floating-content-container">
              <div>
                ...
                {/* <div className="w-fit hidden lg:inline-block mx-auto mt-5 xl:hidden">

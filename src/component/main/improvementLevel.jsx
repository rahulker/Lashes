...
const ImprovementLevel = () => {
  return (
    <section className="product-background">
      <div className=" bg-white level-product text-center relative marging rounded-lg">
        <CustomTitle
        ...
        {/* floating  section */}
        {/* <div className="mt-10 flex lg:flex-row flex-col items-center floating-banner text-left gap-10 absolute">
          <img src={PathImage.bannerImage} />
          <div className="mobile-responsive text-center">
            ...
            <button className="text-white lg:hidden mt-5 lg:mt-0 Custom-btn new-btn flex items-center justify-center gap-2.5 w-full">
              Jetzt registrieren
              <FontAwesomeIcon
                icon={faArrowRight}
                style={{ color: "#ffffff" }}
          ...
          <button className="text-white mt-5 lg:mt-0 Custom-btn new-btn lg:flex items-center justify-center gap-2.5 hidden ">
            Jetzt registrieren
